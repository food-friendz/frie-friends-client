...
export default function Signup() {
  ...
  const [validLength, hasNumber, upperCase, match, specialChar] =
            ...
            >
              ...
              <div className="flex flex-col">
                <div className="flex justify-evenly mb-4">
                  <span
                    className={
                      validLength ? "text-emerald-500" : "text-red-500"
                    }
                  >
                    8 Characters
                  </span>
                  <span
                    className={hasNumber ? "text-emerald-500" : "text-red-500"}
                  >
                    Has a Number
                  </span>
                  <span
                    className={upperCase ? "text-emerald-500" : "text-red-500"}
                  >
                    Upper Case
                  </span>
                </div>
                <div className="flex justify-evenly mb-4">
                  <span
                    className={
                      specialChar ? "text-emerald-500" : "text-red-500"
                    }
                  >
                    Special Character
                  </span>
                  ...
                  <div className="flex">
                    ...
                    <div className="ml-3">
                      <h3 className="text-sm font-medium text-red-800">
                        Oh no! Passwords didn't match. Try again!
                      </h3>
                    </div>
                  </div>
                </div>
